...
const ProjetoView = () => {
  const [projeto] = useState([
...

    {
      ...
      bandeira: "eua.png",
      descricao:
        "A BioFabrication Facility utiliza impressoras 3D especializadas e biocompatíveis para criar tecidos biológicos complexos em ambiente de microgravidade onde a gravidade não interfere com o processo de impressão.",
...

    {
      ...
      bandeira: "eua.png",
      descricao:
        "O ARISS permite que estudantes e astronautas se comuniquem via rádio amador, promovendo educação científica global e testes de comunicação espacial.",
...

    {
      ...
      bandeira: "japao.png",
      descricao:
        "O PCG produz cristais de proteína de alta qualidade no espaço, ajudando no desenvolvimento de medicamentos avançados.",
...

    {
      ...
      bandeira: "china.png",
      descricao:
        "Missão chinesa para coletar amostras do asteroide Kamoʻoalewa e depois explorar um cometa do cinturão principal.",
      fotoProjeto: null,
      status: true,
    },

    {
      ...
      bandeira: "china.png",
      descricao:
        "Missão chinesa para explorar o Polo Sul da Lua, incluindo um mini voador para investigar crateras permanentemente sombreadas.",
      fotoProjeto: null,
      status: true,
    },

    {
      ...
      bandeira: "india.png",
      descricao:
        "Segunda missão orbital de Marte da ISRO, com instrumentos científicos aprimorados para estudar a atmosfera marciana.",
      fotoProjeto: null,
      status: false,
    },

    {
      ...
      bandeira: "india.png",
      descricao:
        "Primeira missão solar da Índia, posicionada no ponto de Lagrange L1 para observar continuamente o Sol.",
      fotoProjeto: null,
      status: true,
    },
  ]);
  ...
  const projetosFiltrados = projeto.filter((p) =>
    p.titulo.toLocaleLowerCase().includes(busca.toLocaleLowerCase())
  );
